                ...
                if (!context.Set<EServiceCategory>().Any())
                {
                    context.Set<EServiceCategory>().AddRange(new List<EServiceCategory>()
                    {
									 ...
									 new EServiceSubCategory()
										{
											...
											CreatedOn = DateTime.Now,
											ServiceFees=0,DurationDays="حسب اتفاقية مستوى الخدمة",
											DescriptionAr="تتيح هذه الخدمة إمكانية التقديم على طلب زواج سعودي من غير سعودية من الخارج إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة",
									 ...
									 new EServiceSubCategory()
										{
											...
											CreatedOn = DateTime.Now,
											ServiceFees=20,
											DescriptionAr="تتيح هذه الخدمة إمكانية التقديم على طلب زواج سعودي من غير سعودية مقيمة ومولودة بالمملكة إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
									  ...
									  new EServiceSubCategory()
										{
											...
											CreatedOn = DateTime.Now,
											ServiceFees=20,
											DescriptionAr="تتيح هذه الخدمة إمكانية التقديم على طلب زواج سعودي من غير سعودية مقيمة ومولودة خارج المملكة إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
									 ...
									 new EServiceSubCategory()
										{
											...
											CreatedOn = DateTime.Now,
											ServiceFees=20,
											DescriptionAr="تتيح هذه الخدمة إمكانية التقديم على طلب زواج سعودية من غير سعودي مولود بالمملكة إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                        ...
                        new EServiceCategory()
                        {
                            ...
                            CreatedOn = DateTime.Now,
                            ServiceFees=20,
                            DescriptionAr="طلب يتقدم المواطن للسماح له بالسفر خلال مدة المنع من السفر إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                        ...
                        new EServiceCategory()
                        {
                            ...
                            CreatedOn = DateTime.Now,
                            ServiceFees=0,DurationDays="حسب اتفاقية مستوى الخدمة",
                            DescriptionAr="تتيح هذه الخدمة للمستفيد إمكانية التقدم بطلب تنفيذ حكم صادر ضد جهة حكومية إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة.\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
							...
							EServiceSubCategories = new List<EServiceSubCategory>(){
							    new EServiceSubCategory(){
								 ...
								 new EServiceSubCategory(){
										...
										CreatedOn = DateTime.Now,
										ServiceFees=0,DurationDays="حسب اتفاقية مستوى الخدمة",
										DescriptionAr="طلب يتقدم به أحد أقارب السجين يلتمس فيه نقل السجين من سجنه الحالي إلى سجن آخر ويقدم إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب يكون عن طريق الموقع الرسمي للإمارة .\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
