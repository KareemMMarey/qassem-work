    ...
    public class AppDbInitializer
    {
        public static void Seed(IServiceCollection services, WebApplicationBuilder builder)
        {
            using (ServiceProvider serviceProvider = services.BuildServiceProvider())
            {
                ...
                {
                    context
                        .Set<EServiceCategory>()
                        .AddRange(
                            new List<EServiceCategory>()
                            {
                                new EServiceCategory()
                                {
                                    ...
                                    EServiceSubCategories = new List<EServiceSubCategory>()
                                    {
                                        ...
                                        new EServiceSubCategory()
                                        {
                                            ...
                                            ServiceFees = 20,
                                            DescriptionAr =
                                                "تتيح هذه الخدمة إمكانية التقديم على طلب زواج سعودي من غير سعودية مقيمة ومولودة خارج المملكة إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                                            ServiceRequierment =
                                        ...
                                        new EServiceSubCategory()
                                        {
                                            ...
                                            ServiceFees = 20,
                                            DescriptionAr =
                                                "تتيح هذه الخدمة إمكانية التقديم على طلب زواج سعودية من غير سعودي مولود بالمملكة إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                                            ServiceRequierment =
                                ...
                                new EServiceCategory()
                                {
                                    ...
                                    ServiceFees = 20,
                                    DescriptionAr =
                                        "طلب يتقدم المواطن للسماح له بالسفر خلال مدة المنع من السفر إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                                    ServiceRequierment =
                                ...
                                new EServiceCategory()
                                {
                                    ...
                                    DurationDays = "حسب اتفاقية مستوى الخدمة",
                                    DescriptionAr =
                                        "تتيح هذه الخدمة للمستفيد إمكانية التقدم بطلب تنفيذ حكم صادر ضد جهة حكومية إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب عن طريق الموقع الرسمي للإمارة.\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                                    ServiceRequierment =
                                        "  <li>إرفاق صورة من الهوية الوطنية</li>\r\n                    <li>إرفاق صورة لحكم ابتدائي</li>\r\n                    <li>إرفاق صورة لحكم استئناف (إن وجد)</li>\r\n                    <li>إرفاق صورة الوكالة(في حال وجود وكيل)</li>",
                                    EServiceSubCategories = new List<EServiceSubCategory>()
                                    {
                                        new EServiceSubCategory()
                                        {
                                ...
                                new EServiceCategory()
                                {
                                    ...
                                    EServiceSubCategories = new List<EServiceSubCategory>()
                                    {
                                        ...
                                        new EServiceSubCategory()
                                        {
                                            ...
                                            DurationDays = "حسب اتفاقية مستوى الخدمة",
                                            DescriptionAr =
                                                "طلب يتقدم به أحد أقارب السجين يلتمس فيه نقل السجين من سجنه الحالي إلى سجن آخر ويقدم إلكترونياً لعدد من الحالات بدون زيارة إمارة منطقة القصيم ومتابعة الطلب يكون عن طريق الموقع الرسمي للإمارة .\r\n\r\nملاحظة : لاستخدام الخدمات يتوجب عليك الدخول من خلال النفاذ الوطني الموحد",
                                            ServiceRequierment =
                                                "  <li>تعبئة البيانات المطلوبة (اسم السجين-صلة القرابة للسجين-اسم السجن الحالي-اسم السجن المراد النقل إليه-اسم المنطقة التي يقع فيها السجن-القضية المحكوم فيها )</li>\r\n                    <li>صورة الهوية الوطنية لمقدم الطلب</li>\r\n                    <li>سبب طلب نقل السجين وإرفاق المستندات المثبتة لصحة ذلك</li>",
                                        },
                                        new EServiceSubCategory()
                                        {
                        ...
                        .AddRange(
                            new List<RequestType>()
                            {
                                new RequestType()
                                {
                                    NameAr = "زواج سعودي من غير سعودية من الخارج",
                                    NameEn =
                                        "Marriage of a Saudi man to a non-Saudi woman from abroad",
                                    IsActive = true,
                                    CreatedBy = "admin",
                                    CreatedOn = DateTime.Now,
                                },
                                new RequestType()
                                {
                                    ...
                                    NameEn =
                                        "Marriage of a Saudi woman to a non-Saudi woman residing and born in the Kingdom",
                                    IsActive = true,
                                    CreatedBy = "admin",
                                    CreatedOn = DateTime.Now,
                                },
                                new RequestType()
                                {
                                    ...
                                    NameEn =
                                        "Marriage of a Saudi woman to a non-Saudi woman residing and born outside the Kingdom",
                                    IsActive = true,
                                    CreatedBy = "admin",
                                    CreatedOn = DateTime.Now,
                                },
                                new RequestType()
                                {
                                    NameAr = "زواج سعودية من غير سعودي مولود بالمملكة",
                                    NameEn =
                                        "Marriage of a Saudi woman to a non-Saudi born in the Kingdom",
                                    IsActive = true,
                                    CreatedBy = "admin",
                                    CreatedOn = DateTime.Now,
                                },
                                ...
                                new RequestType()
                                {
                                    NameAr = "طلب تنفيذ حكم صادر ضد جهة حكومية",
                                    NameEn =
                                        "Request to implement a judgment issued against a government entity",
                                    IsActive = true,
                                    CreatedBy = "admin",
                                    CreatedOn = DateTime.Now,
                                },
