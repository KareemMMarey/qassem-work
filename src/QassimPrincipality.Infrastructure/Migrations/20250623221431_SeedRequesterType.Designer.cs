...
namespace QassimPrincipality.Infrastructure.Migrations
{
    ...
    [Migration("20250623221431_SeedRequesterType")]
    partial class SeedRequesterType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QassimPrincipality.Domain.Entities.Lookups.NewSchema.EService", b =>
                {
                    ...
                    b.Property<bool>("HasApplicantStatus")
                        .HasColumnType("bit");

                    b.Property<bool>("HasTypeOfSummons")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ServiceActionMethos")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceController")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("QassimPrincipality.Domain.Entities.Lookups.NewSchema.ServiceDataSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ServiceDataSource", "lookup");
                });
            ...
            modelBuilder.Entity("QassimPrincipality.Domain.Entities.Lookups.NewSchema.ServiceStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QassimPrincipality.Domain.Entities.Lookups.NewSchema.ServiceDataSource", b =>
                {
                    b.HasOne("QassimPrincipality.Domain.Entities.Lookups.NewSchema.ServiceStep", "ServiceStep")
