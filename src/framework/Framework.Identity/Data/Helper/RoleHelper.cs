...
namespace Framework.Identity.Data.Helper
{
    public static class RoleHelper
    {
        ...
        public static Guid EServicesRequestAdmin { get; set; } = new Guid("1f64eb96-40f2-4a55-91c0-ed6f8b887a93");
        public static Guid SuperAdmin { get; set; } = new Guid("a19b49c1-4874-4286-94c8-cb3ffa156d7d");
        public static Guid OpenDataRequestAdmin { get; set; } = new Guid("ef106849-6607-44eb-8be5-4a6356a01ead");
        public static Guid ShareDataRequestAdmin { get; set; } = new Guid("f1032b5f-9ac0-486e-adad-40c7e0eeaec4");
    }
}