...
namespace Framework.Identity.Data.Services.Interfaces
{
    public interface IRoleAppService
    {
        ...
        public Task<IEnumerable<SelectListItem>> GetRolesListByCategory(int id);
        public Task<IEnumerable<SelectListItem>> GetReferralsDepartmentsList(int id);
        public Task<IEnumerable<SelectListItem>> GetReferralsSubdepartmentsList(int id);
        public Task<IEnumerable<SelectListItem>> GetReferralsDirectorsList(int id);
        public Task<IEnumerable<SelectListItem>> GetReferralsManagersList(int id);
        public Task<bool> DeleteAsync(Guid id);

        public Task<List<string>> GetRoleNamesByIds(List<Guid> ids);
        public Task<List<RoleDto>> GetRolesByIds(List<Guid> ids);
        ...
        public Task<List<RoleDto>> GetRolesByCategoryAsync(int category);
