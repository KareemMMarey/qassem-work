...
namespace Framework.Identity.Data.Services.Interfaces
{
    public interface IUserAppService
    {
        ...
        public Task<UserDto> GetByIdEditMode(Guid id);
        ...
        public Task<Guid> UpdateProfileInfoAsync(UserDto input);
        ...
        public Task<List<ApplicationUser>> FindByIds(List<string> ids);
        ...
        public Task<RoleDto> GetFirstRoleOfCurrentuser();
    }
}